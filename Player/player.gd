...
@export var sprint_speed: float = 10.0  # Новая переменная для скорости спринта
@export var jump_velocity: float = 6.0
@export var gravity: float = 9.8
@export var rotation_speed: float = 10.0
@export var sprint_stamina: float = 100.0  # Запас выносливости
@export var stamina_drain_rate: float = 20.0  # Скорость расхода выносливости
@export var stamina_regen_rate: float = 15.0  # Скорость восстановления
